...
mod tests {
    ...
    fn test_command_parsing() {
        ...
        assert_eq!(
            ChatCommand::parse("/branch my_branch"),
            Some(ChatCommand::Branch(Some("my_branch".to_string())))
        );
        assert_eq!(
        ...
        assert_eq!(
            ChatCommand::parse("/remove src/main.rs"),
            Some(ChatCommand::RemoveContext("src/main.rs".to_string()))
        );
    ...
    fn test_command_help_text() {
        ...
        assert_eq!(
            ChatCommand::Retry.help_text(),
            "Regenerate the last AI response"
        );
        assert_eq!(
            ChatCommand::Branch(None).help_text(),
            "Create a new conversation branch"
        );
        assert_eq!(
            ChatCommand::AddContext("".to_string()).help_text(),
            "Add file or directory to context"
        );
        assert_eq!(
            ChatCommand::RemoveContext("".to_string()).help_text(),
